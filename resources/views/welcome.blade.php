        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="p-6">
            <div class="flex items-center">
              ...
              <div class="ml-4 text-lg font-semibold leading-7"><a href="{{ route('home') }}"
                  class="text-gray-900 underline dark:text-white">Home</a></div>
            </div>
          ...
          <div class="border-t border-gray-200 p-6 dark:border-gray-700 md:border-t-0 md:border-l">
            <div class="flex items-center">
              ...
              <div class="ml-4 text-lg font-semibold leading-7"><a href="{{ route('test') }}"
                  class="text-gray-900 underline dark:text-white">Test</a></div>
            </div>
